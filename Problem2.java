...
public class Problem2 extends JFrame {
	...
	public Problem2() {
	 ...
	 // 이미지 파일 로딩
	// images 폴더의 images0.jpg, image1.jpg, image2.jpg, image3.jpg
		...
		c.add(imageLabel, BorderLayout.CENTER);         // 이미지 레이블을 컨텐트팬에 부착
		c.add(new MenuPanel(), BorderLayout.SOUTH); //2개의 화살표 버튼을 가진 MenuPanel을 부착
